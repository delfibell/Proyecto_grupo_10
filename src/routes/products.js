...
router.get("/create", authMiddleware, adminMiddleware, productsControllers.crearProducto); //cambiar ruta en los href

//ruta: /products (POST) - Acción de creación (a donde se envía el formulario)
router.post("/", upload.any("image"), adminMiddleware, authMiddleware, productsControllers.store)
...
router.get("/edit/:id", authMiddleware, adminMiddleware, productsControllers.editarProducto)

//ruta: /products/:id (PUT) - Acción de edición (a donde se envía el formulario):
router.put("/edit/:id", upload.any("image"), authMiddleware, adminMiddleware, productsControllers.modificarProducto)

//ruta para eliminar producto
router.get("/:id/delete", authMiddleware, adminMiddleware, productsControllers.eliminarProducto)

//ruta: /products/:id (DELETE) - Acción de borrado
router.delete("/:id", authMiddleware, adminMiddleware, productsControllers.destruirProducto)
